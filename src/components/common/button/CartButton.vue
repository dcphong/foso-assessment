...
<template>
  ...
  >
    <ShoppingCart
      class="size-6 group-hover:text-(--primary-color)! transition-colors duration-300"
    />
    <span
      class="group-hover:text-(--primary-color)! transition-colors duration-300 font-medium text-base"
    >
      {{ $t("cart") }}</span
    >
    <CircleCounter
